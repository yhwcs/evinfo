...
class ChargerList: ObservableObject {
    ...
    func getStationInformation(latitude: Double, longitude: Double, size: Int) {
        ...
        // main thread에서 수신
            ...
            .tryMap(handleOutput)
            .decode(type: [ChargerListItem].self, decoder: JSONDecoder())
    ...
    func dataFilePath() -> URL {
        let filePath = documentsDirectory().appendingPathComponent("ChargerList.plist")
